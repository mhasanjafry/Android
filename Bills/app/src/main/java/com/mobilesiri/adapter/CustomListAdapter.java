...
public class CustomListAdapter extends BaseAdapter {
    ...
    private List<Bills> BillItems;

    public CustomListAdapter(Activity activity, List<Bills> BillItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Bills m = BillItems.get(position);

        // name
        name.setText(m.getID());

        title.setText(m.getshorttitle());

        date.setText(m.getintroduced_on());
